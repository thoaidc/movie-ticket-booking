...
public interface RabbitMQConstants {
    ...
    interface RoutingKey {
        ...
        String CHECK_SEAT_AVAILABILITY_COMMAND = "routingKey.seats.availability.command";
        String CONFIRM_SEAT_COMMAND = "routingKey.seats.confirm.command";
        String RESERVE_SEAT_COMMAND = "routingKey.seats.reserve.command";
